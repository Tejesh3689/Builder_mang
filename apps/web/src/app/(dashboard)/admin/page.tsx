    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="p-6 rounded-xl bg-white border border-zinc-200 space-y-4">
        ...
        <div className="divide-y divide-zinc-100 text-sm">
          ...
          <div className="py-3.5 flex justify-between">
            <span className="font-semibold text-amber-700">PROJECT_MANAGER</span>
            <span>View Ventures, Approve Requests, Assign Employees</span>
          </div>
          <div className="py-3.5 flex justify-between">
            <span className="font-semibold text-amber-700">SITE_ENGINEER</span>
            <span>Request materials, view assigned ventures, site chat</span>
          </div>
          <div className="py-3.5 flex justify-between">
            <span className="font-semibold text-amber-700">STORE_MANAGER</span>
