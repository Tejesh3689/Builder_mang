    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex items-center gap-4">
          <Link href="/admin/roles" className="p-2 bg-white border border-zinc-200 rounded-lg hover:bg-zinc-50 shrink-0">
        ...
        <button className="px-4 py-2 bg-[#d97706] hover:bg-amber-700 text-white rounded-lg text-sm font-semibold self-start sm:self-auto shrink-0">Save Changes</button>
      </div>
