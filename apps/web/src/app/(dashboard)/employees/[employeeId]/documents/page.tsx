    ...
    <div className="space-y-6 max-w-xl">
      ...
      <div className="p-6 rounded-xl bg-slate-950 border border-slate-800 space-y-4">
        ...
        <div className="space-y-2">
          <div className="p-3 rounded-lg bg-slate-900 border border-slate-800 flex justify-between items-center text-sm">
            <span>Identification_ID.pdf</span>
            <span className="text-xs text-indigo-400 hover:underline cursor-pointer">Download</span>
          </div>
        </div>
      </div>
    </div>
