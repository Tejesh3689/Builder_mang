  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        <Link href="/reports/employees" className="p-2 bg-white border border-zinc-200 rounded-lg hover:bg-zinc-50">
        ...
        <h1 className="text-2xl font-bold text-zinc-900">Export Employee Report</h1>
      </div>
      ...
      <div className="bg-white rounded-xl border border-zinc-200 p-6 shadow-sm">
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="pt-4 border-t border-zinc-100 flex justify-end gap-3">
            <Link href="/reports/employees" className="px-4 py-2 bg-zinc-100 text-zinc-700 rounded-lg text-sm font-semibold hover:bg-zinc-200">Cancel</Link>
